        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
                ...
                <input
                    ...
                    maxLength={1}
                    className="w-12 px-2 py-1 text-center text-white bg-neutral-900 border border-neutral-700 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500"
                />
            </div>
        </div>
    );
...
const SettingsPanel: React.FC<SettingsPanelProps> = ({ theme, setTheme, shortcuts, setShortcuts, onClose, zoom, onZoomChange, aiConfig, setAiConfig }) => {
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2 w-48">
                                ...
                                <input type="number" min="0.2" max="2.5" step="0.1" value={localZoom.toFixed(2)} onChange={e => setLocalZoom(parseFloat(e.target.value))} className="w-20 px-2 py-1 text-center text-white bg-neutral-900 border border-neutral-700 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500" />
                            </div>
                        </div>
                        <div className="flex items-center justify-between">
                        ...
                        {shortcutConfigs.map(sc => (
                         ...
                         <div className="flex items-center justify-between">
                            ...
                            <input
                                ...
                                className="w-24 px-2 py-1 text-center text-white bg-neutral-900 border border-neutral-700 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500"
                            />
                        </div>
                    </div>
                </div>
